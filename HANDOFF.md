...
- The Task 1 consistency test is expected to remain RED until later dependency alignment: current manifests still declare DSH `0.1.1-rc.2` and Cordis `4.0.1`.
